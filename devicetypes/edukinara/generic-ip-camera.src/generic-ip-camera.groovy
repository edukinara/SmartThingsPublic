...
metadata {
	definition (name: "Generic IP Camera", namespace: "edukinara", author: "edukinara") {
    ...
    input("CameraPath", "string", title:"Camera Path to Image", description: "Please enter the path to the image", defaultValue: "/img/snapshot.cgi?size=3", required: false, displayDuringSetup: true)
    input("CameraPathVideo", "string", title:"Camera Path to Video", description: "Please enter the path to the video", defaultValue: "/img/stream/video.mjpeg", required: false, displayDuringSetup: true)
